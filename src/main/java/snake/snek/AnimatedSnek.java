...
public class AnimatedSnek extends AnimatedSprite {
    ...
    private static final SpriteSequence IDLE = new SpriteSequence("idle", generateRow(0), true);
    private static final SpriteSequence SPINNING = new SpriteSequence("spinning", generateRow(1), true);
    private static final SpriteSequence MOVING = new SpriteSequence("moving", generateRow(2), true);
    private static final SpriteSequence EATING = new SpriteSequence("eating", generateRow(3), false);
    private static final SpriteSequence DYING = new SpriteSequence("dying", generateRow(4), false);
